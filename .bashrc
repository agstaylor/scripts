...
# Alias's for docker
alias  dps='docker ps --format "{{.ID}} | {{.Image}}\t| {{.Status}}\t| {{.Names}}"'
...
function whatsmyip ()
{
	...
	echo -n "External IP: " ; dig +short myip.opendns.com @resolver1.opendns.com | xargs echo -n
